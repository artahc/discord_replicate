...
class _$ChannelTearOff {
  ...
  _Channel call(
      ...
      @HiveField(2) List<User> members = const <User>[],
...
class _$_Channel implements _Channel {
  const _$_Channel(
      ...
      @HiveField(2) this.members = const <User>[],
  ...
  @override
  String toString() {
    return 'Channel(id: $id, name: $name, members: $members, messages: $messages)';
  }
